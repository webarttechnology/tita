                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-check form-check-inline">
                                                            <input type="color" name="colors[{{ $key }}]" class="form-control form-control-color"
                                                                value="{{ $color->color }}" title="Choose your color">
                                                        </div>
                                                        <div class="col-md-3">
                                                            @if($key == 0)
                                                            ...
                                                            @endif
                                                               ...
                                                               onclick="displayAlert('warning', 'Are You Sure, you want to delete this Color?', '{{ url('admin/vehicle/delete/color', $color->id) }}', 'Delete', 'Cancel', 'NA')"><i class="fa fa-times btn btn-danger"></i></a>
                                                    </div>
                                                    </div>
                                                    @endforeach
