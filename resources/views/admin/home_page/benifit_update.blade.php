              ...
              <div class="ec-vendor-uploads">
                <div class="col-lg-12">
                  <div class="ec-vendor-upload-detail">
                      <form class="separate-form" method="POST" action="{{route ('admin.benifit_update', ['id' => $data->id])}}" enctype="multipart/form-data">
                        @method('PUT')
                         @csrf
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <img src="{{ asset('images/home/benifits/'. $data->image) }}" width="50px">
                      </div>
